...
We also provide an [analysis script](https://raw.githubusercontent.com/OpenVT/playground/main/PhysiCell/models/ctypes_graph.py) which determines the number of clusters (connected components of a graph) of each cell type:
<pre>
