...
We also provide an <a href=https://github.com/OpenVT/playground/blob/main/PhysiCell/models/ctypes_graph.py>analysis script</a> which determines the number of clusters (connected components of a graph) of each cell type:
<pre>
